            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="{{ route('admin.partner.index') }}"
                       class="text-muted text-hover-primary"> {{trans('Toolbar.partners')}}</a>
                </li>
                <li class="breadcrumb-item">
                    <span class="bullet bg-gray-400 w-5px h-2px"></span>
                </li>
                <li class="breadcrumb-item text-muted">
                    {{trans('Toolbar.partnersCreate')}}
                </li>
...
@section('content')
 ...
 <!----------------------------------------------------------------->
    ...
    action="{{route('admin.partner.update',$one_data->id)}}" method="post" enctype="multipart/form-data">
      @csrf
      ...
      <input type="hidden" name="id" value="{{$one_data->id}}">
                                ...
                                <div class="card-body text-center pt-0">
                                    ...
                                    <div class="mb-7">
                                        ...
                                        <div
                                            ...
                                            style="background-image:url({{asset($one_data->Image) }})"></div>
                                    ...
                                    @error('image')
                                    <div class="invalid-partner">{{ $message }}</div>
                                    @enderror
                                </div>
                                <!--end::Card body-->
                            </div>
                    ...
                    <div class="mb-10 fv-row arabic">
                                        ...
                                        <input type="text" name="title_ar"
                                               ...
                                               placeholder="title in Arabic" value="{{old('title_ar',$one_data->title_ar)}}"/>
                                        <!--end::Input-->
                                        @error('title_ar')
                                        <div class="fv-plugins-message-container invalid-partner">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <!--end::Input group-->
                                      <!--begin::Input group-->
                                      <div class="mb-10 fv-row english">
                                        ...
                                        <input type="text" name="title_en"
                                               ...
                                               placeholder="title in English" value="{{old('title_en',$one_data->title_en)}}"/>
                                        <!--end::Input-->
                                        @error('title_en')
                                        <div class="fv-plugins-message-container invalid-partner">{{ $message }}</div>
                                        @enderror
                                   ...
                                   <div class="mb-10 fv-row">
                                    <!--begin::Label-->
                                    <label class="required form-label">{{trans('dash_site.link')}}
                                    ...
                                    <input type="text" name="link"
                                           ...
                                           placeholder="put a link here " value="{{old('link',$one_data->link)}}" />
