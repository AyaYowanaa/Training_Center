...
@section('content')
                ...
                <div id="kt_app_content_container" class="app-container container-xxxl">
                    ...
                    <form id="StorForm" class="form d-flex flex-column flex-lg-row "
                          action="{{route('admin.partner.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="card-body pt-0">
                                   ...
                                   <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="link"
                                           ...
                                           placeholder="put a link here " value=""/>
                                    <!--end::Input-->
                                    @error('link')
                                    <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                    @enderror
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Site\partner\PartnerRequest', '#StorForm') !!}
