                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row english">
                                        ...
                                        <input type="text" name="name_en"
                                               ...
                                               placeholder="Write your name in English" value="{{old('name_en')}}"/>
                                        <!--end::Input-->
                                        @error('name_en')
                                    ...
                                    <div class="mb-10 fv-row english">
                                        ...
                                        <input type="text" name="jop_title_en"
                                               ...
                                               placeholder="Write your job title in English" value="{{old('jop_title_en')}}"/>
                                        <!--end::Input-->
                                        @error('jop_title_en')
                                        <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <!--begin::Editor-->
                                        <textarea id="feedback_en" name="feedback_en"
                                                  class="min-h-200px mb-2 @error('feedback_en') is-invalid @enderror">{{old('feedback_en')}}</textarea>
                                        <!--end::Editor-->
                                        @error('feedback_en')
                                        <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-10 fv-row arabic">
                                        ...
                                        <input type="text" name="name_ar"
                                               ...
                                               placeholder="Write your name in Arabic" value="{{old('name_ar')}}"/>
                                        <!--end::Input-->
                                        @error('name_ar')
                                        <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-10 fv-row arabic">
                                        ...
                                        <input type="text" name="jop_title_ar"
                                               ...
                                               placeholder="Write your Job title in Arabic" value="{{old('jop_title_ar')}}"/>
                                        <!--end::Input-->
                                        @error('jop_title_ar')
                                        <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <!--begin::Editor-->
                                        <textarea id="feedback_ar" name="feedback_ar"
                                                  class="min-h-200px mb-2 @error('feedback_ar') is-invalid @enderror">{{old('feedback_ar')}}</textarea>
                                        <!--end::Editor-->
                                        @error('feedback_ar')
                                        <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                        @enderror
