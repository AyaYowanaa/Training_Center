                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <input type="text" name="sub_title_en"
                                   ...
                                   placeholder="sub title in English" value="{{old('sub_title_en')}}"/>
                            <!--end::Input-->
                            @error('sub_title_en')
                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <input type="text" name="sub_title_ar"
                                   ...
                                   placeholder="sub title in Arabic" value="{{old('sub_title_ar')}}"/>
                            <!--end::Input-->
                            @error('sub_title_ar')
                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                            @enderror
...
@section('js')
   ...
   {{-- {!! JsValidator::formRequest('App\Http\Requests\Site\banner\StoreRequest', '#StorForm') !!}
   --}} 
   <script>
