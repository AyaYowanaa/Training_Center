            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="{{ route('admin.banner.index') }}"
                       class="text-muted text-hover-primary"> {{trans('Toolbar.banner')}}</a>
                </li>
                <li class="breadcrumb-item">
                    <span class="bullet bg-gray-400 w-5px h-2px"></span>
                </li>
                <li class="breadcrumb-item text-muted">
                    {{trans('Toolbar.bannerCreate')}}
                </li>
...
@section('content')
                ...
                <div id="kt_app_content_container" class="app-container container-xxxl">
                    ...
                    <form id="StorForm" class="form d-flex flex-column flex-lg-row "
                          action="{{route('admin.banner.update',$one_data->id)}}" method="post"
                        ...
                        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row">
                                        <!--begin::Label-->
                                        <label class="required form-label">{{trans('dash_site.sub_title')}}
                                            <span class="text-muted fs-7">"{{trans('forms.lable_en')}}"</span>
                                        ...
                                        <input type="text" name="sub_title_en"
                                               class="form-control mb-2  @error('sub_title_en') is-invalid @enderror"
                                               placeholder="sub title in English"
                                               value="{{old('sub_title_en',$one_data->sub_title_en)}}"/>
                                        <!--end::Input-->
                                        @error('sub_title_en')
                                        <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" name="sub_title_ar"
                                               class="form-control mb-2  @error('sub_title_ar') is-invalid @enderror"
                                               placeholder="sub title in Arabic"
                                               value="{{old('sub_title_ar',$one_data->sub_title_ar)}}"/>
                                        <!--end::Input-->
                                        @error('sub_title_ar')
                                        <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                        @enderror
