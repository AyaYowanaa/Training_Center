            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="{{ route('admin.advantages.index') }}"
                       class="text-muted text-hover-primary"> {{trans('Toolbar.advantages')}}</a>
                </li>
                <li class="breadcrumb-item">
                    <span class="bullet bg-gray-400 w-5px h-2px"></span>
                </li>
                <li class="breadcrumb-item text-muted">
                    {{trans('dash_site.Advantages')}}
                </li>
...
@section('content')
 ...
 <!----------------------------------------------------------------->
    ...
    action="{{route('admin.advantages.update',$one_data->id)}}" method="post" enctype="multipart/form-data">
      @csrf
                                ...
                                <div class="card-body pt-0">
                                    <!--begin::Input group-->
                                     ...
                                     <div class="mb-10 fv-row">
                                       <!--begin::Label-->
                                       <label class="required form-label">{{trans('dash_site.icon')}}
                                       ...
                                       <!--begin::Input-->
                                         <select class="form-select mb-2 @error('icon') is-invalid @enderror"
                                                 ...
                                                 id="icon" name="icon">
                                             @include('dashbord.admin.Site.advantages.options')
                                         </select>
                                    ...
                                    <div class="mb-10 fv-row english">
                                       ...
                                       <textarea name="title_en"
                                              ...
                                              placeholder="Title in English" value="">{{$one_data->title_en}}</textarea>
                                       <!--end::Input-->
                                       @error('title_en')
                                       <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                       @enderror
                                   ...
                                   <!--end::Input group-->
                                    <div class="mb-10 fv-row arabic">
                                       ...
                                       <textarea name="title_ar"
                                              ...
                                              placeholder="Title in arabic" value="">{{$one_data->title_ar}}</textarea>
                                       <!--end::Input-->
                                       @error('title_ar')
                                       <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                       @enderror
                                   ...
                                   <!--end::Input group-->
                                         ...
                                         <div class="mb-10 fv-row english">
                                           ...
                                           <textarea name="description_en"
                                                  ...
                                                  placeholder="" value="">{{$one_data->description_en}}</textarea>
                                           <!--end::Input-->
                                     ...
                                     <div class="mb-10 fv-row arabic">
                                       ...
                                       <textarea name="description_ar"
                                              ...
                                              placeholder="" value="">{{$one_data->description_ar}}</textarea>
                                       <!--end::Input-->
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Site\advantages\AdvantagesRequest', '#StorForm') !!}
          <script>
