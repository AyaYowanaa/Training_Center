                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row english">
                            ...
                            <input type="text" name="address_en"
                                   ...
                                   placeholder="Address in English" value="{{old('address_en')}}"/>
                            <!--end::Input-->
                            @error('address_en')
                        ...
                        <div class="mb-10 fv-row english">
                            ...
                            <input type="text" name="sub_address_en"
                                   ...
                                   placeholder="Sub Address in english" value="{{old('sub_address_en')}}"/>
                            <!--end::Input-->
                        ...
                        <div class="mb-10 fv-row arabic">
                            ...
                            <input type="text" name="address_ar"
                                   ...
                                   placeholder="Address in Arabic" value="{{old('address_ar')}}"/>
                            <!--end::Input-->
                            @error('address_ar')
                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-10 fv-row arabic">
                            ...
                            <input type="text" name="sub_address_ar"
                                   ...
                                   placeholder="Sub Address in Arabic" value="{{old('sub_address_ar')}}"/>
                            <!--end::Input-->
