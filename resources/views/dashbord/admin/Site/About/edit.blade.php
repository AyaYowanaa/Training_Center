    ...
    <form id="StorForm" class="form d-flex flex-column flex-lg-row "
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row english">
                            <!--begin::Label-->
                            <label class="required form-label">{{trans('dash_site.address')}}
                        ...
                        <div class="mb-10 fv-row english">
                            <!--begin::Label-->
                            <label class="required form-label">{{trans('dash_site.sub_address')}}
                                <span class="text-muted fs-7">"{{trans('forms.lable_en')}}"</span>
                            ...
                            <input type="text" name="sub_address_en"
                                   ...
                                   placeholder="Sub Address in english" value="{{old('sub_address_en',$one_data->sub_address_en)}}"/>
                            <!--end::Input-->
                        ...
                        <!--begin::Editor-->
                            <textarea id="details_en" name="details_en"
                                      class="min-h-200px mb-2 @error('details_en') is-invalid @enderror">{{$one_data->details_en}}</textarea>
                            <!--end::Editor-->
                            @error('details_en')
                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-10 fv-row arabic">
                            ...
                            <input type="text" name="address_ar"
                                   ...
                                   placeholder="Address in Arabic" value="{{old('address_ar',$one_data->address_ar)}}"/>
                            <!--end::Input-->
                            @error('address_ar')
                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-10 fv-row arabic">
                            ...
                            <input type="text" name="sub_address_ar"
                                   ...
                                   placeholder="Sub Address in Arabic" value="{{old('sub_address_ar',$one_data->sub_address_ar)}}"/>
                            <!--end::Input-->
...
@section('js')
   ...
   {{-- {!! JsValidator::formRequest('App\Http\Requests\Site\banner\UpdateRequest', '#StorForm') !!}  --}}
    <script>
