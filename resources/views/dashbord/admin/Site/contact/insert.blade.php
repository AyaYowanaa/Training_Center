            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="{{ route('admin.dashboard') }}" class="text-muted text-hover-primary">
                        {{trans('dash_site.Back')}}</a>
                </li>
                <li class="breadcrumb-item text-muted">
                    <a href="{{ route('admin.dashboard') }}"
                       class="text-muted text-hover-primary"> {{trans('dash_site.Next')}}</a>
                </li>
    ...
    <div id="kt_app_content_container" class="app-container container-xxxl">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-10 fv-row">
                            <label class="required form-label"> {{trans('dash_site.Fax')}}</label>
                            <input type="text" name="fax" id="fax" class="form-control mb-2"
                                   placeholder=" fax " value="{{old('fax',$mdata->fax)}}"/>
                        </div>
                        <div class="mb-10 fv-row">
                            <label class="required form-label"> {{trans('dash_site.Phone')}}</label>
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        ?>
                        <div class="mb-10 fv-row">
                            <label for="name_ar" class="required form-label"> {{trans('dash_site.Company Name')}}</label>
                            <span
                        ...
                        <div class="mb-10 fv-row">
                            <label for="name_en" class="required form-label"> {{trans('dash_site.Company Name')}}</label>
                            <span
                        ...
                        <div class="mb-10 fv-row">
                            <label class="required form-label">{{trans('dash_site.Email')}} </label>
                            <input type="text" name="email" id="email" class="form-control mb-2"
                                   placeholder=" Email " value="{{old('email',$mdata->email)}}"/>
                        </div>
                        <div class="mb-10 fv-row">
                            <label for="address_ar" class="required form-label">{{trans('dash_site.Address')}}</label>
                            <span
                                class="text-muted">({{ trans('forms.lable_ar') }})</span>
                        ...
                        <div class="mb-10 fv-row">
                            <label for=address_en class="required form-label">{{trans('dash_site.Address')}}</label>
                        ...
                        <!--begin::Label-->
                        <label for=description_ar class="form-label">{{trans('dash_site.Description')}}</label>
                        ...
                        <!--begin::Label-->
                        <label for=description_en class="form-label">{{trans('dash_site.Description')}}</label>
                        <span class="text-muted">({{ trans('forms.lable_en') }})</span>
                        <div class="text-muted fs-7">
      ...
      <textarea name="maplocation"
                ...
                rows="2" placeholder="">
                        ...
                        <div class="mb-10 fv-row">
                            <label class="required form-label">{{trans('dash_site.Location on Map')}}</label>
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <button type="reset" id="kt_ecommerce_add_category_submit"
                        ...
                        <span class="indicator-label">{{trans('dash_site.Cancel')}}</span>
