            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="{{ route('admin.statistics.index') }}"
                       class="text-muted text-hover-primary"> {{trans('Toolbar.statistics')}}</a>
                </li>
                <li class="breadcrumb-item">
                    <span class="bullet bg-gray-400 w-5px h-2px"></span>
                </li>
                <li class="breadcrumb-item text-muted">
                    {{trans('Toolbar.statisticsCreate')}}
                </li>
...
@section('content')
 ...
 <!----------------------------------------------------------------->
    ...
    action="{{route('admin.statistics.update',$one_data->id)}}" method="post" enctype="multipart/form-data">
      @csrf
      ...
      <input type="hidden" name="id" value="{{$one_data->id}}">
                    ...
                    <div class="mb-10 fv-row arabic">
                                   ...
                                   <div class="mb-10 fv-row">
                                    <!--begin::Label-->
                                    <label class="required form-label">{{trans('dash_site.number')}}
                                    ...
                                    <input type="text" name="number"
                                           ...
                                           placeholder="number" value="{{old('number',$one_data->number)}}" />
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Site\statistics\StatisticsRequest', '#StorForm') !!} 
