...
@section('content')
                ...
                <div id="kt_app_content_container" class="app-container container-xxxl">
                    ...
                    <form id="StorForm" class="form d-flex flex-column flex-lg-row "
                          action="{{route('admin.staff.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Aside column-->
                                ...
                                <div class="card-body text-center pt-0">
                                    <div class="row g-9 mb-7">
                                        ...
                                        <div class="">
                                            <!--begin::Label-->
                                            <label
                                                class="required fs-6 fw-semibold mb-2">{{trans('dash_site.phone')}}</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="tel"
                                        ...
                                        <div class="">
                                            <!--begin::Label-->
                                            <label
                                                class="required fs-6 fw-semibold mb-2">{{trans('dash_site.email')}}</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="email"
                        ...
                        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row">
                                        <!--begin::Label-->
                                        <label class="required form-label">{{trans('dash_site.jop_title')}}
                                            <span class="text-muted fs-7">"{{trans('forms.lable_en')}}"</span>
                                    ...
                                    <div class="mb-10 fv-row">
                                        <!--begin::Label-->
                                        <label class="form-label">{{trans('dash_site.description')}}
                                            <span class="text-muted fs-7">"{{trans('forms.lable_en')}}"</span>
                                        </label>
                                        <!--end::Label-->
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Site\Staff\StoreRequest', '#StorForm') !!}
    <script>
