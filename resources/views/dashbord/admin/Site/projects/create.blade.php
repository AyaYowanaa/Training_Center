            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="{{ route('admin.projects.index') }}"
                       class="text-muted text-hover-primary"> {{trans('Toolbar.projects')}}</a>
                </li>
                <li class="breadcrumb-item">
                    <span class="bullet bg-gray-400 w-5px h-2px"></span>
                </li>
                <li class="breadcrumb-item text-muted">
                    {{trans('Toolbar.projectsCreate')}}
                </li>
            ...
            <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-header">
                        <!--begin::Card title-->
                        <div class="card-title">
                            <h2>{{trans('dash_site.time_data')}}</h2>
                        </div>
                        <!--end::Card title-->
                    </div>
                    <!--end::Card header-->
                    ...
                    <div class="card-body text-center pt-0">
                        <div class="row g-9 mb-7">
                          ...
                          {{--  <div class="">
                                <!--begin::Label-->
                                <label
                                    class="required fs-6 fw-semibold mb-2">{{trans('dash_site.date_at')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input
                            ...
                            <div class="">
                                <!--begin::Label-->
                                <label
                                    class="required fs-6 fw-semibold mb-2">{{trans('dash_site.from_time')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="time"
                            ...
                            <div class="">
                                <!--begin::Label-->
                                <label
                                    class="required fs-6 fw-semibold mb-2">{{trans('dash_site.to_time')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="time"
                        ...
                        <!--begin::Col-->
                            <div class="">
                                <!--begin::Label-->
                                <label
                                    class="required fs-6 fw-semibold mb-2">{{trans('dash_site.publisher')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input
...
--}}
                            <div>
                                <div class="mb-10 fv-row col">
                                    <label
                                        class="required fs-6 fw-semibold mb-2">{{trans('dash_site.city')}}
                                    </label>
                            ...
                            <div>
                                <div class="mb-10 fv-row col">
                                    <label
                                        class="required fs-6 fw-semibold mb-2">{{trans('dash_site.district')}}
                                    </label>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <input type="text" name="title_en"
                                   ...
                                   placeholder="" value="{{old('title_en')}}"/>
                            <!--end::Input-->
                            @error('title_en')
                        ...
                        <div class="mb-10 fv-row">
                            <!--begin::Label-->
                            <label class="form-label">{{trans('dash_site.features')}}
                                <span class="text-muted fs-7">"{{trans('forms.lable_en')}}"</span>
                            </label>
                            <!--end::Label-->
                        {{--                                        <input type="hidden" id="features_en" name="features_en" >--}}
                        <!--begin::Editor-->
                            <textarea id="features_en" name="features_en"
                                      class="min-h-200px mb-2 @error('features_en') is-invalid @enderror"></textarea>
                            <!--end::Editor-->
                            @error('features_en')
                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <input type="text" name="title_ar"
                                   ...
                                   placeholder="" value="{{old('title_ar')}}"/>
                            <!--end::Input-->
                            @error('title_ar')
                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                            @enderror
   ...
   <!--begin::Input group-->
                        <div class="mb-10 fv-row">
                            ...
                            <!--end::Label-->
                        {{--                                        <input type="hidden" id="features_ar" name="features_ar" >--}}

                        <!--begin::Editor-->
                            <textarea id="features_ar" name="features_ar"
                                      class=" min-h-200px mb-2 @error('features_ar') is-invalid @enderror"></textarea>
                            <!--end::Editor-->
                            @error('features_ar')
                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-header">
                        <div class="card-title">
                            <h2>{{trans('dash_site.location_data')}}</h2>
                        </div>
                    </div>
                    <!--end::Card header-->
                    <!--begin::Card body-->
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            <!--begin::Label-->
                            <label class="required form-label">{{trans('dash_site.location_map')}}
                            </label>
                            <!--end::Label-->
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Site\Event\StoreRequest', '#StorForm') !!}
    <script>
