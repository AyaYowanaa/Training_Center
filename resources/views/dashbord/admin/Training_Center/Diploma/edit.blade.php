...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-xxxl">
        ...
        <form id="StorForm" class="form d-flex flex-column flex-lg-row "
              action="{{route('admin.TrainingCenter.Diploma.update',$one_data->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
...
?>
                            <div class="col-md-4">
                                ...
                                <input type="text" name="name_en"
                                       ...
                                       placeholder="{{trans('diploma.name')}}" 
                         ...
                         <div class="col-md-4">
                            ...
                            <input type="text" name="levels"
                                ...
                                value="{{old('levels',$one_data->levels)}}"
                                placeholder="{{ trans('diploma.levels') }}">
                            @error('levels')
                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-10 fv-row row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="total_price"
                                       ...
                                       placeholder="{{trans('diploma.total_price')}}" 
                                       value="{{old('total_price',$one_data->total_price)}}"/>
                                <!--end::Input-->
                                @error('total_price')
                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-10 fv-row row">
                            <div class="col-md-6 english">
                                ...
                                <textarea id="description_en" name="description_en"
                                          class="min-h-200px mb-2 @error('description_en') is-invalid 
                                          @enderror">{{old('description_en',$description['en'])}}</textarea>
                                <!--end::Editor-->
                            ...
                            <div class="col-md-6 arabic">
                                ...
                                <textarea id="description_ar" name="description_ar"
                                          class="min-h-200px mb-2 @error('description_ar') is-invalid
                                          @enderror">{{old('description_ar',$description['ar'])}}</textarea>
                                <!--end::Editor-->
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\training_center\Diploma\UpdateRequest', '#StorForm') !!}
