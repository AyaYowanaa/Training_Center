        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="card py-4">
                ...
                <div class="card-body pt-15">
                    ...
                    @endif
                    <form id="multi-step-form"   action="{{route('admin.Settings.training_courses.update',$one_data->id)}}"
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" name="title_en"
                                           ...
                                           placeholder="{{trans('course.name')}}" value="{{old('title_en',$title['en'])}}"/>
                                    <!--end::Input-->
                                    @error('title_en')
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" name="title_ar"
                                           ...
                                           placeholder="{{trans('course.name')}}" value="{{old('title_ar',$title['ar'])}}"/>
                                    <!--end::Input-->
                                    @error('title_ar')
                                    <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="mb-10 fv-row row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="capacity"
                                           ...
                                           placeholder="{{trans('course.capacity',$one_data->capacity)}}"/>
                                    <!--end::Input-->
                                    @error('capacity')
                                    <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input
                                        ...
                                        value="{{old('to_date',$one_data->to_date)}}" name="from_date"
