...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-xxxl">
        ...
        <form id="StorForm" class="form d-flex flex-column flex-lg-row "
              action="{{route('admin.Settings.training_courses.update',$one_data->id)}}" method="post"
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            <!--begin::Label-->
                            <label class="required form-label">{{trans('dash_site.details')}}
                                <span class="text-muted fs-7">"{{trans('forms.lable_en')}}"</span>
                            </label>
                            <!--end::Label-->
                                        ...
                                        <div class="card shadow-sm">
                                            ...
                                            <div class="card-body">
                                                <div class="card-toolbar">
                                                    <a href="{{route('admin.Settings.training_courses.destroy_image',$image->imageId)}}"
