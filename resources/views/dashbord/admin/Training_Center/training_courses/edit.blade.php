...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-xxxl">
        ...
        <form id="StorForm" class="form d-flex flex-column flex-lg-row "
              action="{{route('admin.Settings.training_courses.update',$one_data->id)}}" method="post" enctype="multipart/form-data">
        @csrf
...
?>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="duration"
                                       ...
                                       placeholder="{{trans('course.duration')}}"
                                       value="{{old('duration',$one_data->duration)}}" />
                                <!--end::Input-->
                                @error('duration')
                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-10 fv-row row">
                            ...
                            <div class="col-md-4">
                                    ...
                                    <input
                                        ...
                                        value="{{old('to_date',$one_data->to_date)}}" name="to_date"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="capacity"
                                       ...
                                       value="{{old('capacity',$one_data->capacity)}}"/>
                                <!--end::Input-->
                                @error('capacity')
                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-10 fv-row row">
                            <div class="col-md-4">
                                ...
                                <label class="required form-label">{{trans('course.Courses')}}
                                    ...
                                    <option value="{{ $row->id }}"  @if($one_data->courses_id==$row->id) {{'selected'}} @endif>{{ $row->name}}</option>
                                @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="fee"
                                       ...
                                       placeholder="{{trans('course.fee')}}" value="{{old('fee',$one_data->fee)}}"/>
                                <!--end::Input-->
                                @error('fee')
                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                @enderror
...
@section('js')
    ...
    <script type="text/javascript" src="{{ asset('vendor/jsvalidation/js/jsvalidation.js')}}"></script>
     ...
     {!! JsValidator::formRequest('App\Http\Requests\training_center\training_courses\UpdateRequest', '#StorForm') !!}
 <script>
