    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                {{trans('trainingCenter.TrainingCourses')}}</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="{{ route('admin.Settings.Entity.index') }}"
                       class="text-muted text-hover-primary">{{trans('Toolbar.TrainingCourses')}}</a>
                </li>
                <li class="breadcrumb-item">
                    <span class="bullet bg-gray-400 w-5px h-2px"></span>
                </li>
                <li class="breadcrumb-item text-muted">
                    {{trans('Toolbar.TrainingCourseDetails')}}
                </li>
                ...
                <div class="m-0">
                    ...
                    <div class="d-flex flex-stack flex-wrap align-items-end">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <!--begin::Text-->
                            <span
                                class="fw-bold text-gray-600 fs-6 mb-2 d-block">{{$one_data->fee}}</span>
                            <!--end::Text-->
                        </div>
                        <!--end::User-->
            ...
            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
                ...
                <li class="nav-item">
                    <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                       href="#students">{{trans('trainingCenter.Students')}}</a>
                </li>
                <!--end:::Tab item-->
                <!--begin:::Tab item-->
                <li class="nav-item">
                    ...
                    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                        ...
                        <div class="card-body p-9">
                            ...
                            <div class="row mb-7">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8">
                                    <span class="fw-bold fs-6 text-gray-800">{{$one_data->title}}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Row-->
                            ...
                            <div class="row mb-7">
                                <!--begin::Label-->
                                <label
                                    class="col-lg-4 fw-semibold text-muted">{{trans('trainingCenter.Course')}}</label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8">
                                    <span class="fw-bold fs-6 text-gray-800">{{optional($one_data->coursesData)->name}}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Row-->
                            ...
                            <div class="row mb-7">
                                <!--begin::Label-->
                                <label
                                    class="col-lg-4 fw-semibold text-muted">{{trans('trainingCenter.location')}}</label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8">
                                    <span class="fw-bold fs-6 text-gray-800">{{optional($one_data->locationData)->name}}</span>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Row-->
                            ...
                            <div class="row mb-7">
                                <!--begin::Label-->
                                <label
                                    class="col-lg-4 fw-semibold text-muted">{{trans('trainingCenter.Duration')}}</label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8">
                                    <a href="#"
                                       class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{$one_data->duration}}</a>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-7">
                                <!--begin::Label-->
                                <label
                                    class="col-lg-4 fw-semibold text-muted">{{trans('trainingCenter.Fees')}}</label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8">
                                    <a href="#"
                                       class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{$one_data->fee}}</a>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-7">
                                <!--begin::Label-->
                                <label
                                    class="col-lg-4 fw-semibold text-muted">{{trans('trainingCenter.From_Date')}}</label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8">
                                    <a href="#"
                                       class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{$one_data->from_date}}</a>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-7">
                                <!--begin::Label-->
                                <label
                                    class="col-lg-4 fw-semibold text-muted">{{trans('trainingCenter.To_Date')}}</label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8">
                                    <a href="#"
                                       class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{$one_data->to_date}}</a>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-7">
                                <!--begin::Label-->
                                <label
                                    class="col-lg-4 fw-semibold text-muted">{{trans('trainingCenter.Capacity')}}</label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8">
                                    <a href="#"
                                       class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{$one_data->capacity}}</a>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                ...
                <div class="tab-pane fade" id="students" role="tabpanel">
                    ...
                    <div class="card pt-4 mb-6 mb-xl-9">
                        ...
                        <div class="card-header border-0">
                            <!--begin::Card title-->
                            <div class="card-title">
                                <h2 class="fw-bold mb-0">{{trans('trainingCenter.TrainingCourse')}}</h2>
                            </div>
                            <!--end::Card title-->
