    ...
    <div class="modal fade" id="exampleModal" tabindex="-1"
     aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form action="{{route('admin.Settings.typesetting.store')}}" method="POST" id="kt_ecommerce_add_product_form"
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="{{route('admin.Settings.typesetting.edit', $x->id)}}"
                                    ...
                                    <a href="{{route('admin.Settings.typesetting.delete', $x->id)}}"
            ...
            @foreach  ($obj as $x)
                <!-- Modal 1-->
                    <div class="modal fade" id="exampleModal{{$x->id}}" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <!--begin::Formmmmm-->
                            <form action="{{route('admin.Settings.typesetting.update',$x->id)}}" method="POST"
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\setting\type_settingRequest', '.my-form'); !!}
