...
@section('content')
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form action="{{route('admin.Settings.mainsetting.store')}}" method="POST"
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="{{route('admin.Settings.mainsetting.edit', $x->id)}}"
                                    ...
                                    <a href="{{route('admin.Settings.mainsetting.delete', $x->id)}}"
            ...
            @foreach  ($main as $x)
                <!-- Modal 1-->
                    <div class="modal fade" id="exampleModal{{$x->id}}" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <!--begin::Formmmmm-->
                            <form action="{{route('admin.Settings.mainsetting.update',$x->id)}}" method="POST"
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\setting\mainsettinRequest', '.my-form'); !!}
