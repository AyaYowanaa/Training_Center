                ...
                <div class="m-0">
                    ...
                    <div class="d-flex flex-stack flex-wrap align-items-end">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <!--begin::Text-->
                            <span
                                class="fw-bold text-gray-600 fs-6 mb-2 d-block">{{$one_data->short_description}}</span>
                            <!--end::Text-->
                            <!--begin::Info-->
                            <div class="d-flex align-items-center flex-wrap fw-semibold fs-7 pe-2">
                                <a href="#"
                                   class="d-flex align-items-center text-gray-400 text-hover-primary">{{optional($one_data->category)->name}}</a>
                                <span class="bullet bullet-dot h-5px w-5px bg-gray-400 mx-3"></span>
                                {{--<a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary">Austin,
                                    TX</a>
                                <span class="bullet bullet-dot h-5px w-5px bg-gray-400 mx-3"></span>
