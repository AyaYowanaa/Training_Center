    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                {{trans('trainingCenter.CourseEvaluation')}}</h1>
            <!--end::Title-->
               <!--begin::Breadcrumb-->
               <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    {{trans('Toolbar.Create_Evaluation')}}
                </li>
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <!--begin::Filter menu-->
            <div class="d-flex">
                <a href="{{route('admin.TrainingCenter.Evaluation.index')}}"
...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-xxxl">
        ...
        <form id="StorForm" class="form d-flex flex-column flex-lg-row "
              action="{{route('admin.TrainingCenter.Evaluation.store')}}" method="post" enctype="multipart/form-data">
            @csrf
...
@section('js')
   ...
   {{--  {!! JsValidator::formRequest('App\Http\Requests\training_center\Evaluation\StoreRequest','#StorForm'); !!}
