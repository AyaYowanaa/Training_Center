                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="q_text"
                                       class="form-control @error('q_text') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="q_type" class="form-select @error('q_type') is-invalid @enderror"
                                        required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="mark" min="1"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="q_answer"
                                       class="form-control @error('q_answer') is-invalid @enderror"
                                       placeholder="{{ trans('exams.Question_answer') }}"
                                       value="{{ old('q_answer') }}"/>
                                @error('q_answer')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
