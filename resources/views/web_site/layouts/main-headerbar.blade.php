     ...
     <header class="all-navbar <?= Route::currentRouteName() == 'home' || Route::currentRouteName() == '' ? "fixed-top" : 'home-2' ?>">
        <!-- :: Navbar -->
        <nav class="nav-bar">
            <div class="container">
                <div class="content-box d-flex align-items-center justify-content-between">
                    <div class="logo">
                        ...
                        <?php if (app()->getLocale() == 'en') { ?>
                         ...
                         <a href="{{ LaravelLocalization::getLocalizedURL('ar', null, [], true) }}" class="lang dismob"> <span class="menu-icon open"><img src="{{asset('assets_web/img/ar.png')}}"> AR</span></a>
                                                 <?php } elseif (app()->getLocale() == 'ar') { ?>

                        <a href="{{ LaravelLocalization::getLocalizedURL('en', null, [], true) }}" class="lang dismob"> <span class="menu-icon open"><img src="{{asset('assets_web/img/en.png')}}"> EN</span></a>
                        <?php } ?>
                    ...
                    <div class="nav-bar-links" id="open-nav-bar-menu">
                        <ul class="level-1">
                            ...
                            <li class="item-level-1">
                                <a href="{{route('projects')}}" class="link-level-1 <?= Route::currentRouteName() == 'projects' || Route::currentRouteName() == 'one_project' ? "color-active" : '' ?>">{{trans('web_site.projects')}}</a>
                            </li>
                            <li class="item-level-1">
                        ...
                        <li class="item phone">
                            <div class="nav-bar-contact">
                                ...
                                <div class="content-box">
                                    <span>{{trans('web_site.Phone_Number')}}</span>
                                    <a href="tel:97159351156">{{$mainData->phone}}</a>
                                </div>
                            </div>
                        </li>
