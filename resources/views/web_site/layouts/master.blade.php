...
<a href="https://wa.me/{{(!empty($mainData->phone)) ? $mainData->phone : '0120347859'}}" target="_blank" title="facebook"><i class="fab fa-whatsapp">  </i> </a>
 <a href="tel:{{(!empty($mainData->phone)) ? $mainData->phone : '0120347859'}}" target="_blank" title="youtube"> <i class="fas fa-phone-alt">   </i>  </a>
</div>
