    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="{{route('student.dashboard')}}" class="d-lg-none">
                <img alt="Logo" src="{{asset((!empty($mainData->image)) ? $mainData->image : 'assets/media/logos/default-small.svg')}}" class="theme-light-show h-30px"/>
                <img alt="Logo" src="{{asset((!empty($mainData->image)) ? $mainData->image : 'assets/media/logos/default-small-dark.svg')}}" class="theme-dark-show h-30px"/>
            </a>
        </div>
        <!--end::Mobile logo-->
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3">
                    ...
                    <div
                        ...
                        @if(app()->getLocale() =='en')
                            <?php $image_lang=asset('assets/media/flags/united-kingdom.svg')?>
                        @elseif(app()->getLocale() =='ar')
                            <?php $image_lang=asset('assets/media/flags/united-arab-emirates.svg') ?>
                        @endif
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">{{auth('student')->user()->name}}
{{--                                        <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span>--}}
                                    </div>
                                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">{{auth('student')->user()->email}}</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
                        ...
                        <div class="menu-item px-5">
                            <a href="{{route('admin.UserManagement.users.edit',auth('student')->user()->id)}}" class="menu-link px-5">My Profile</a>
                        </div>
                        <!--end::Menu item-->
