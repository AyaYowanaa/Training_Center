...
//use DataTables;
use App\Http\Requests\setting\type_settingRequest;
...
class TypeSettingController extends Controller
{
    ...
    {
        $obj=TypeSetting::all();
        return view('dashbord.admin.Training_Center.setting.typesetting.create',compact('obj'));
    }
    ...
    public function store(type_settingRequest $request)
    {
         try {
            ...
            return redirect()->route('admin.Settings.typesetting.index');
