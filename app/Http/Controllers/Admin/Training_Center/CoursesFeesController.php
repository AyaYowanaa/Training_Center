                   ...
                   <span class="svg-icon svg-icon-5 m-0">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                        <div class="menu-item px-3">
                             <a href="' . route('admin.Settings.CoursesFees.edit', $row->id) . '"
                               address="' . trans('forms.edite_btn') . '" class="menu-link px-3"
                               >' . trans('forms.edite_btn') . '</a>
                        </div>
                   		
                        <div class="menu-item px-3">
                                <a href="javascript:void(0)" data-kt-table-details="details_row" data-url="' . route('admin.Settings.CoursesFees.load_details', $row->id) . '"
                                           address="' . trans('forms.details') . '" class="menu-link px-3"
                                         data-bs-toggle="modal" data-bs-target="#kt_modal_1"  >' . trans('forms.details') . '</a>
                        </div>
                        <div class="menu-item px-3">
                                <a href="' . route('admin.Settings.CoursesFees.destroy', $row->id) . '" data-kt-table-delete="delete_row"
    ...
    public function store(Request $request)
    {
        ...
        try {
          //  dd($request->input('courses_id'));
            ...
            return redirect()->route('admin.Settings.CoursesFees.index');
        } catch (\Exception $e) {
