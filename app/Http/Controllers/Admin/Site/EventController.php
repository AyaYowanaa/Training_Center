...
class EventController extends Controller
{
    ...
    protected $upload_folder = 'Site/Events';
    ...
    public function index(Request $request)
    {
                   ...
                   <span class="svg-icon svg-icon-5 m-0">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                        <div class="menu-item px-3">
                   		...
                   		<div class="menu-item px-3">
                                <a href="' . route('admin.event.show', $row->id) . '"
                                           title="' . trans('forms.details') . '" class="menu-link px-3"
                                           >' . trans('forms.details') . '</a>
                        </div>
                        <div class="menu-item px-3">
                                <a href="' . route('admin.event.destroy', $row->id) . '" data-kt-table-delete="delete_row"
        ...
        return view('dashbord.admin.Site.Events.index');
    }
    ...
    {
        return view('dashbord.admin.Site.Events.create');
    ...
    public function store(StoreRequest $request)
    {
        try {
            ...
            $inserted_data = SiteEvent::create($insert_data);
            ...
            if ($request->hasFile('images')) {
                ...
                SiteEventImage::insert($blog_images);
            }
    ...
    {
        $one_data = SiteEvent::with('images')->findOrFail($id);
...
//        $data['one_data'] = $this->prepare_data($one_data->edite_data($one_data));
        ...
        return view('dashbord.admin.Site.Events.details', $data);
    }
    ...
    public function edit($id)
    {
        ...
        $one_data = new EventResource($one_data);
        $data['one_data'] = $this->prepare_data($one_data->edite_data($one_data));
        return view('dashbord.admin.Site.Events.edit', $data);
    ...
    {
        try {
            $data = SiteEvent::find($request->id);
    ...
    public function destroy($id)
    {
        try {
            ...
            $delete_data = SiteEvent::with('images')->find($id);
    ...
    {
        try {
            $delete_data = SiteEventImage::find($id);
