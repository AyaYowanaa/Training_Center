...
use App\Models\Site\SitePolices;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;
use Yajra\DataTables\Facades\DataTables;
use App\Http\Requests\Site\polices\PolicesRequest;
use App\Http\Resources\Site\PolicesResource;
class SitePolicesController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
                   ...
                   <span class="svg-icon svg-icon-5 m-0">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                        <div class="menu-item px-3">
                             <a href="' . route('admin.polices.edit', $row->id) . '"
                               name="' . trans('forms.edite_btn') . '" class="menu-link px-3"
                               >' . trans('forms.edite_btn') . '</a>
                        </div>
                               <div class="menu-item px-3">
                                    <a href="' . route('admin.polices.show', $row->id) . '"
                                               name="' . trans('forms.details') . '" class="menu-link px-3"
                                               >' . trans('forms.details') . '</a>
                            </div>
                      
                        <div class="menu-item px-3">
                                <a href="' . route('admin.polices.destroy', $row->id) . '" data-kt-table-delete="delete_row"
        ...
        return view('dashbord.admin.Site.polices.index');
    ...
    {
     return view ('dashbord.admin.Site.polices.create');   
    }

    /**
     * Store a newly created resource in storage.
     */
    public function store(PolicesRequest $request)
    {
        try {
            ...
            $inserted_data =SitePolices::create($insert_data);
    ...
    {
        $one_data = SitePolices::findOrFail($id);
        $one_data = new PolicesResource($one_data);
        $data['one_data'] = $this->prepare_data($one_data);
        return view('dashbord.admin.Site.polices.details', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashbord.admin.Site.polices.edit', $data);
     ...
     */
    public function update(PolicesRequest $request,$id)
    {
        try {
            $data = SitePolices::find($request->id);
    ...
    public function destroy($id)
    {
        try {
            ...
            $delete_data = SitePolices::find($id);
            SitePolices::destroy($id);
