...
use App\Http\Requests\Site\advantages\AdvantagesRequest;
use App\Http\Resources\Site\AdvantagesResource;
class SiteAdvantageController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
                   ...
                   <span class="svg-icon svg-icon-5 m-0">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                        <div class="menu-item px-3">
                             <a href="' . route('admin.advantages.edit', $row->id) . '"
                               name="' . trans('forms.edite_btn') . '" class="menu-link px-3"
                               >' . trans('forms.edite_btn') . '</a>
                        </div>
                               <div class="menu-item px-3">
                                    <a href="' . route('admin.advantages.show', $row->id) . '"
                                               name="' . trans('forms.details') . '" class="menu-link px-3"
                                               >' . trans('forms.details') . '</a>
                            </div>
                      
                        <div class="menu-item px-3">
                                <a href="' . route('admin.advantages.destroy', $row->id) . '" data-kt-table-delete="delete_row"
        ...
        return view('dashbord.admin.Site.advantages.index');
    ...
    {
     return view ('dashbord.admin.Site.advantages.create');   
    }
    ...
    public function store(AdvantagesRequest $request)
    {
        try {
            ...
            $inserted_data =SiteAdvantage::create($insert_data);
    ...
    {
        $one_data = SiteAdvantage::findOrFail($id);
        $one_data = new AdvantagesResource($one_data);
        $data['one_data'] = $this->prepare_data($one_data);
        return view('dashbord.admin.Site.advantages.details', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashbord.admin.Site.advantages.edit', $data);
    ...
    {
        try {
            $data = SiteAdvantage::find($request->id);
    ...
    public function destroy($id)
    {
        try {
            ...
            $delete_data = SiteAdvantage::find($id);
            SiteAdvantage::destroy($id);
